...
{
    public class TouchIDAuthenticationAndroid : IAuthentication
    {
        ...
        public void Authenticate(Action successAction, Action failAction)
        {
            ...
            var page = new FingerPrintView((int)Android.OS.Build.VERSION.SdkInt);
        ...
        {
            bool result = await App.Current.MainPage.DisplayAlert(title, message, ok_str, cancel_str);
            if (result)
            {
                ok_action.Invoke();
            }
